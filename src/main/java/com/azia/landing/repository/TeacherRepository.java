...
public interface TeacherRepository extends JpaRepository<Teacher, Integer> {
    ...
    @Transactional
    @Query("update Teacher t set t.image = :image where t.id = :id")
    void changeImage(Image image, Integer id);

    @Transactional
    @Query("update Teacher t set t.image = null where t.id = :teacherId")
    void setImageNull(Integer teacherId);
